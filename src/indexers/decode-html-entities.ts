/** Decodes the Latin-1 HTML4 named entities + numeric refs that show up in
 *  Cardigann-wrapped release titles (`Berl&iacute;n`) and HTML-escaped `.torrent` names.
 *  Also covers plain XML entities (`&amp;`), so it doubles as the XML decoder below. */
